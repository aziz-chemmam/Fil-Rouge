        ...
        <div id="form"
            ...
            <form action="/admin" method="POST" class="w-[700px] rounded-xl mx-auto bg-orange-700  ">
                ...
                <div class="w-[90%] mx-auto flex flex-col items-center">
                    ...
                    <button class="bg-white text-orange-700 border-[0.2rem] border-orange-700 hover:bg-orange-700 hover:text-white active:bg-black transition duration-300 ease-in-out rounded-xl px-8 py-3 ">
                        Submit
                    </button>
                </div>
            </form>
