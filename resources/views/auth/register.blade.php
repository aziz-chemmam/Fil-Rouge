          ...
          <form method="POST">
            ...
            <div class="flex gap-28">
                <div>
                    ...
                    <input name="fname" type="fname" id="fname" class="inline-block w-full rounded-xl bg-white p-2.5 leading-none text-black  "  />
                  </div>
                <div>
                    <label class="mb-2.5 block text-orange-700 font-extrabold" for="lname">Last Name</label>
                    <input name="lname" type="lname" id="lname" class="inline-block w-full rounded-xl bg-white p-2.5 leading-none text-black " />
                  </div>
               </div>
            <div>
            ...
            <div class="mt-4">
                <select name="role" class="inline-block w-full rounded-xl bg-white p-2.5 leading-none text-black" for="role">
